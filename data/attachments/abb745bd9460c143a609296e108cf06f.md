...
- Name: api/basket/isolation.spec.ts >> Basket isolation between users >> Does not let another user check out a victim's basket
- Location: tests/api/basket/isolation.spec.ts:48:3
